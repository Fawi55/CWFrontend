    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, Elbaz.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with Elbaz
          ...
          agreed to or set forth in writing by Elbaz, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to Elbaz's acceptance. This means
          Elbaz may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, Elbaz
        ...
        <p>
          ...
          and it is accepted by Elbaz. Prices for products displayed on
          ...
          website may differ from those in stores that stock Elbaz
          products, as these stores are independent of Elbaz.
          Elbaz reserves the right to amend pricing for any pricing
          ...
          submitted an online order, Elbaz will notify you of the error
        ...
        <p>
          ...
          Elbaz reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse Elbaz if it pays, any
          taxes, except for those based on Elbaz's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by Elbaz for when the
          ...
          are beyond our control. Elbaz cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by Elbaz, customer
          may not cancel such accepted order without Elbaz’s prior
          ...
          expenses. The product(s) must be returned to Elbaz within
        ...
        <p>
          ...
          indemnify and hold Elbaz harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>Elbaz</p>
        <p style={{ fontWeight: "500" }}>123 Main Street, City, Country</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@Elbaz.com</span>
        </p>
      </div>
    </div>
  );
